...
export default function ListProperty(props) {
    ...
    const getdata = async() => {
        ...
        let res =  await axios.get("http://localhost:8074/property/getall/2");
                        ...
                        <Row>
                            <Col className="col-8">
                                <aside className="img-zoom-container">
                                    <img src={"/images1/"+propertyData[0]?.photoModel[1].photopath} alt="img" style={{ height: "420px", width: '100%' }} />
                                </aside>
